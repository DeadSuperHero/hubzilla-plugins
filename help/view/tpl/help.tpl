...
<!--    <script src="view/js/docs/rainbow/rainbow.min.js"></script>
    <script src="view/js/docs/rainbow/language/generic.js"></script>
    <script src="view/js/docs/rainbow/language/html.js"></script>
    <script src="view/js/docs/rainbow/language/css.js"></script>
    <script src="view/js/docs/rainbow/language/javascript.js"></script>
    <script src="view/js/docs/rainbowlines/rainbow.linenumbers.js"></script>
    <script src="view/js/docs/jquery.min.js"></script>
    <script src="view/js/docs/jquery-ui.min.js"></script>
    <script src="view/js/docs/bootstrap.min.js"></script>
    <script src="view/js/docs/jquery.tocify.min.js"></script>
    <script src="view/js/docs/prettify.js"></script>-->
